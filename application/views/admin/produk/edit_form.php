						...
						<input type="hidden" name="id" value="<?php echo $produk->id_produk?>"/>
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('nama') ? 'is-invalid':'' ?>"
								 type="text" name="nama" placeholder="Produk nama" value="<?php echo $produk->nama?>"/>
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('harga') ? 'is-invalid':'' ?>"
								 type="number" name="harga" min="0" placeholder="Produk harga" value="<?php echo $produk->harga?>"/>
								<div class="invalid-feedback">
